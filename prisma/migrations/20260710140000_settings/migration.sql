...
INSERT INTO "document_sequences" (
    ...
    ('00000000-0000-4000-8000-000000000201', '00000000-0000-4000-8000-000000000101', 'RENTAL_ORDER', 'RO-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000202', '00000000-0000-4000-8000-000000000101', 'PAYMENT', 'PAY-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000203', '00000000-0000-4000-8000-000000000101', 'DISPATCH', 'DSP-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000204', '00000000-0000-4000-8000-000000000101', 'EXPENSE', 'EXP-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000205', '00000000-0000-4000-8000-000000000101', 'REPAIR', 'RPR-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000206', '00000000-0000-4000-8000-000000000101', 'CUSTOMER', 'CUS-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000207', '00000000-0000-4000-8000-000000000101', 'PRODUCT', 'PRD-', 1, 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
