...
INSERT INTO "dashboard_widgets" (
    ...
    ('00000000-0000-4000-8000-000000000401', 'db000001-0000-4000-8000-000000000001', 'summary-kpis', 'Summary KPIs', 'KPI', '{}', 0, 0, 12, 2, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000402', 'db000001-0000-4000-8000-000000000001', 'rental-orders-overview', 'Rental Orders', 'TABLE', '{}', 2, 0, 6, 4, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000403', 'db000001-0000-4000-8000-000000000001', 'inventory-status', 'Inventory Status', 'KPI', '{}', 2, 6, 6, 4, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000404', 'db000001-0000-4000-8000-000000000001', 'dispatch-queue', 'Dispatch Queue', 'LIST', '{}', 6, 0, 4, 3, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000405', 'db000001-0000-4000-8000-000000000001', 'returns-pending', 'Pending Returns', 'LIST', '{}', 6, 4, 4, 3, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000406', 'db000001-0000-4000-8000-000000000001', 'revenue-summary', 'Revenue Summary', 'METRIC', '{}', 6, 8, 4, 3, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000407', 'db000001-0000-4000-8000-000000000001', 'expense-summary', 'Expense Summary', 'METRIC', '{}', 9, 0, 6, 3, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-4000-8000-000000000408', 'db000001-0000-4000-8000-000000000001', 'recent-payments', 'Recent Payments', 'TABLE', '{}', 9, 6, 6, 3, 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
