...
export class CompleteMaintenanceService {
  constructor(
      ...
      async ({
        ...
        if (userId === undefined) {
          throw new UnauthorizedError({
            message: "User context is required to complete maintenance",
          });
        }
        ...
        await executeCreateStockMovementInScope(
          ...
          },
          {
            ...
            remarks: `Maintenance completed for ${existing.maintenanceNumber}`,
          },
        );
