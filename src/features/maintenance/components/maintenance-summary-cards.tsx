...
import type { MaintenanceSummaryStats } from "../mappers/maintenance-summary.mapper";

type MaintenanceSummaryCardsProps = {
  stats: MaintenanceSummaryStats | undefined;
  isLoading?: boolean;
  className?: string;
};

type SummaryCardConfig = {
  id: keyof MaintenanceSummaryStats;
  label: string;
  hint: string;
...
const cardConfigs: SummaryCardConfig[] = [
  ...
  },
  {
    id: "completedCount",
    label: "Completed",
    hint: "Finished maintenance jobs",
...
export function MaintenanceSummaryCards({
  ...
  if (isLoading) {
    return (
      <div
        ...
        aria-busy="true"
        aria-label="Loading maintenance summary"
      >
  ...
  return (
    <section aria-label="Maintenance summary" className={className}>
