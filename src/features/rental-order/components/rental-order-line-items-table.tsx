          ...
          return (
            ...
            >
              ...
              <dl className="mt-3 grid grid-cols-2 gap-x-3 gap-y-2 text-sm">
                ...
                <div>
                  <dt className="text-xs text-muted-foreground">Qty / Rate</dt>
                  <dd className="tabular-nums">
                    {item.quantity} · {formatCurrency(item.dailyRate)}/day
                  </dd>
                </div>
                <div className="col-span-2">
                  <dt className="mb-1 text-xs text-muted-foreground">Reservation</dt>
